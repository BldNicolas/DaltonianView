...
print("Vous avez choisi :", liste.get(a),a)  #Donne le choix fait, a est le numéro de la liste
 
liste = Listbox(fenetre)
bouton=Button(fenetre, text="Appuyez pour choisir", command=selection) #boutton validant le choix
bouton.pack()
liste.insert(1, "Deutéranope") #numéro 0 de la liste
