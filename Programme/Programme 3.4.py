...
#    print("Vous avez choisi :", liste.get(a))  #Donne le choix fait, a est le numéro de la liste
#
#
#bouton=Button(fenetre, text="Appuyez pour choisir", command=selection) #boutton validant le choix
#bouton.pack()
#liste.insert(1, "Deuteranope") #numéro 0 de la liste
#liste.insert(2, "Tritanope")   #numéro 1 de la liste
#liste.insert(3, "Monochromate")   #numéro 2 de la liste
#
#liste.pack()
#liste.curselection()
...
print ("1 = afficher ; 0 = ne pas afficher")
d = int(input("Deuteranope ? "))
t = int(input("Tritanope ? "))
mono = int(input("Monochromatique ? "))
...
while (x<l) and (y<m) :
    ...
    elif red>170 and red<=212 and green>170 and green<=212 and blue<=42 :      # 136
        (red,green,blue,unknow)=(191,191,21,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>170 and red<=212 and green>212 and blue>128 and blue<=170 :      # 137
        (red,green,blue,unknow)=(191,233,64,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>128 and red<=170 and green>170 and green<=212 and blue>128 and blue<=170 :      # 138
        (red,green,blue,unknow)=(149,191,149,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>85 and red<=128 and green>128 and green<=170 and blue>85 and blue<=128 :      # 139
        (red,green,blue,unknow)=(107,149,64,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>85 and red<=128 and green>128 and green<=170 and blue>85 and blue<=128 :      # 140
        (red,green,blue,unknow)=(107,149,107,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>85 and red<=128 and green>170 and green<=212 and blue>85 and blue<=128 :      # 141
        (red,green,blue,unknow)=(107,191,107,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>85 and red<=128 and green>170 and green<=212 and blue>128 and blue<=170 :      # 142
        (red,green,blue,unknow)=(107,191,149,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>170 and red<=212 and green>85 and green<=128 and blue<=42 :      # 143
        (red,green,blue,unknow)=(191,107,21,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>85 and red<=128 and green>85 and green<=128 and blue<=42 :      # 144
        (red,green,blue,unknow)=(107,107,21,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>128 and red<=170 and green>85 and green<=128 and blue>85 and blue<=128 :      # 145
        (red,green,blue,unknow)=(149,107,107,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>170 and red<=212 and green>128 and green<=170 and blue<=42 :      # 146
        (red,green,blue,unknow)=(191,149,21,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>170 and red<=212 and green>128 and green<=170 and blue>128 and blue<=170 :      # 147
        (red,green,blue,unknow)=(191,149,149,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>128 and red<=170 and green>85 and green<=128 and blue>42 and blue<=85 :      # 148
        (red,green,blue,unknow)=(149,107,64,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>212 and green>170 and green<=212 and blue>170 and blue<=212 :      # 149
        (red,green,blue,unknow)=(233,191,191,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>85 and red<=128 and green>128 and green<=170 and blue<=42 :      # 150
        (red,green,blue,unknow)=(107,149,21,255)
        i.putpixel((x,y,),(red,green,blue,unknow))

    elif red>212 and green>128 and green<=170 and blue>42 and blue<=85 :      # 151
        (red,green,blue,unknow)=(233,149,64,255)
        i.putpixel((x,y,),(red,green,blue,unknow))
...
if (d) == (1) :
    ...
    while (x<l) and (y<m) :
        ...
        if red <= 42 and green <= 42 and  blue <= 42:     # 1
            ...
            (red,green,blue,unknow)=(233,175,35,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>212 and blue>128 and blue<=170 :      # 137
            (red,green,blue,unknow)=(255,210,141,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>170 and green<=212 and blue>128 and blue<=170 :      # 138
            (red,green,blue,unknow)=(207,173,153,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(161,133,110,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>170 and green<=212 and blue>85 and blue<=128 :      # 141
            (red,green,blue,unknow)=(206,164,113,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>170 and green<=212 and blue>128 and blue<=170 :      # 142
            (red,green,blue,unknow)=(197,167,154,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>85 and green<=128 and blue<=42 :      # 143
            (red,green,blue,unknow)=(163,122,0,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>85 and green<=128 and blue<=42 :      # 144
            (red,green,blue,unknow)=(145,109,20,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>85 and green<=128 and blue>85 and blue<=128 :      # 145
            (red,green,blue,unknow)=(130,98,26,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue<=42 :      # 146
            (red,green,blue,unknow)=(196,147,23,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue>128 and blue<=170 :      # 147
            (red,green,blue,unknow)=(179,154,148,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(225,194,190,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>128 and green<=170 and blue<=42 :      # 150
            (red,green,blue,unknow)=(171,129,34,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>128 and green<=170 and blue>42 and blue<=85 :      # 151
            (red,green,blue,unknow)=(210,160,61,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    ...
    while (x<l) and (y<m) :
        ...
        if red <= 42 and green <= 42 and  blue <= 42:     # 1
           ...
           i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(0,160,173,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>42 and red<=85 and green>170 and green<=212 and blue>212 :      # 129
            (red,green,blue,unknow)=(45,195,211,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue>212 :      # 130
            (red,green,blue,unknow)=(74,231,249,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue>170 and blue<=212 :      # 131
            (red,green,blue,unknow)=(90,226,244,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue>128 and blue<=170 :      # 132
            (red,green,blue,unknow)=(101,222,240,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
        
        elif red>85 and red<=128 and green>212  and blue>85 and blue<=128 :      # 133
            (red,green,blue,unknow)=(136,219,237,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>212  and blue>128 and blue<=170 :      # 134
            (red,green,blue,unknow)=(166,222,240,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>212  and blue>170 and blue<=212 :      # 135
            (red,green,blue,unknow)=(200,226,244,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>170 and green<=212 and blue<=42 :      # 136
            (red,green,blue,unknow)=(204,178,192,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>212 and blue>128 and blue<=170 :      # 137
            (red,green,blue,unknow)=(209,217,235,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>170 and green<=212 and blue>128 and blue<=170 :      # 138
            (red,green,blue,unknow)=(158,184,199,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(116,143,154,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>170 and green<=212 and blue>85 and blue<=128 :      # 141
            (red,green,blue,unknow)=(128,181,195,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(195,100,107,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>85 and green<=128 and blue<=42 :      # 144
            (red,green,blue,unknow)=(154,100,107,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>85 and green<=128 and blue>85 and blue<=128 :      # 145
            (red,green,blue,unknow)=(114,100,107,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue<=42 :      # 146
            (red,green,blue,unknow)=(198,139,149,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue>128 and blue<=170 :      # 147
            (red,green,blue,unknow)=(192,147,159,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(235,189,204,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>128 and green<=170 and blue<=42 :      # 150
            (red,green,blue,unknow)=(121,139,150,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>128 and green<=170 and blue>42 and blue<=85 :      # 151
            (red,green,blue,unknow)=(238,140,150,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
...
if (mono) == (1) :
    ...
    while (x<l) and (y<m) :
        ...
        if red <= 42 and green <= 42 and  blue <= 42:     # 1
            ...
            (red,green,blue,unknow)=(26,26,26,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
        
        elif red <= 42 and green <= 42 and blue > 85 and blue <= 128 :                # 3
            (red,green,blue,unknow)=(31,31,31,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
        
        elif red <= 42 and green <= 42 and blue <= 170 and blue > 128 :                 # 4
            (red,green,blue,unknow)=(36,36,36,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red <= 42 and green <= 42 and blue <= 212 and blue > 170 :                 # 5
            (red,green,blue,unknow)=(40,40,40,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red <= 42 and green <= 42 and blue > 212 :                 # 6
            (red,green,blue,unknow)=(45,45,45,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>42 and green<=85 and blue<=42 :      # 7
            (red,green,blue,unknow)=(46,46,46,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>85 and green<=128 and blue<=42 :      # 8
            (red,green,blue,unknow)=(71,71,71,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>128 and green<=170 and blue<=42 :      # 9
            (red,green,blue,unknow)=(96,96,96,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>170 and green<=212 and blue<=42 :      # 10
            (red,green,blue,unknow)=(121,121,121,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>212 and blue<=42 :      # 11
            (red,green,blue,unknow)=(145,145,145,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green<=42 and blue<=42 :      # 12
            (red,green,blue,unknow)=(34,34,34,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(59,59,59,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>170 and red<=212 and green<=42  and blue<=42 :      # 15
            (red,green,blue,unknow)=(72,72,72,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and  green<=42 and blue<=42 :      # 16
            (red,green,blue,unknow)=(84,84,84,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>42 and green<=85 and blue<=42 :      # 17
            (red,green,blue,unknow)=(58,58,58,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(109,109,109,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>85 and green<=128 and blue<=42 :      # 22
            (red,green,blue,unknow)=(83,83,83,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(133,133,133,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue<=42 :      # 25
            (red,green,blue,unknow)=(158,158,158,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green<=42 and blue>42 and blue<=85 :      # 26
            (red,green,blue,unknow)=(38,38,38,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green<=42 and blue>42 and blue<=85 :      # 27
            (red,green,blue,unknow)=(52,52,52,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(77,77,77,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>=212 and green<=42 and blue>42 and blue<=85 :      # 30
            (red,green,blue,unknow)=(89,89,89,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>42 and red<=85 and green<=42 and blue>85 and blue<=128 :      # 31
            (red,green,blue,unknow)=(43,43,43,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green<=42 and blue>128 and blue<=170 :      # 32
            (red,green,blue,unknow)=(48,48,48,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green<=42 and blue>170 and blue<=212 :      # 33
            (red,green,blue,unknow)=(53,53,53,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(50,50,50,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>85 and green<=128 and blue>42 and blue<=85 :      # 36
            (red,green,blue,unknow)=(76,76,76,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>128 and green<=170 and blue>42 and blue<=85 :      # 37
            (red,green,blue,unknow)=(101,101,101,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red<=42 and green>170 and green<=212 and blue>42 and blue<=85 :      # 38
            (red,green,blue,unknow)=(126,126,126,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>212 and blue>42 and blue<=85 :      # 39
            (red,green,blue,unknow)=(150,150,150,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>42 and green<=85 and blue>85 and blue<=128 :      # 40
            (red,green,blue,unknow)=(55,55,55,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>42 and green<=85 and blue>128 and blue<=170 :      # 41
            (red,green,blue,unknow)=(60,60,60,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red<=42 and green>42 and green<=85 and blue>170 and blue<=212 :      # 42
            (red,green,blue,unknow)=(65,65,65,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red<=42 and green>42 and green<=85 and blue>212 :      # 43
            (red,green,blue,unknow)=(70,70,70,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>42 and green<=85 and blue>85 and blue<=128 :      # 44
            (red,green,blue,unknow)=(68,68,68,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>42 and green<=85 and blue>128 and blue<=170 :      # 45
            (red,green,blue,unknow)=(74,74,74,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>42 and green<=85 and blue>170 and blue<=212 :      # 46
            (red,green,blue,unknow)=(78,78,78,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(114,114,114,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>42 and red<=85 and green>170 and green<=212 and blue>42 and blue<=85 :      # 50
            (red,green,blue,unknow)=(139,139,139,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue>42 and blue<=85 :      # 51
            (red,green,blue,unknow)=(163,163,163,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(102,102,102,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>42 and green<=85 and blue>42 and blue<=85 :      # 55
            (red,green,blue,unknow)=(115,115,115,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>42 and red<=85 and green>85 and green<=128 and blue>85 and blue<=128 :      # 56
            (red,green,blue,unknow)=(94,94,94,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>85 and green<=128 and blue>128 and blue<=170 :      # 57
            (red,green,blue,unknow)=(99,99,99,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>85 and green<=128 and blue>170 and blue<=212 :      # 58
            (red,green,blue,unknow)=(104,104,104,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(119,119,119,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>170 and green<=212 and blue>85 and blue<=128 :      # 61
            (red,green,blue,unknow)=(143,143,143,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue>85 and blue<=128 :      # 62
            (red,green,blue,unknow)=(168,168,168,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(127,127,127,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>212 and green>85 and green<=128 and blue>42 and blue<=85 :      # 66
            (red,green,blue,unknow)=(140,140,140,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(151,151,151,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>212 and blue>42 and blue<=85 :      # 69
            (red,green,blue,unknow)=(176,176,176,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>42 and green<=85 and blue>85 and blue<=128 :      # 70
            (red,green,blue,unknow)=(82,82,82,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(87,87,87,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>42 and green<=85 and blue>170 and blue<=212 :      # 75
            (red,green,blue,unknow)=(91,91,91,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(144,144,144,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue>85 and blue<=128 :      # 78
            (red,green,blue,unknow)=(157,157,157,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>128 and green<=170 and blue>85 and blue<=128 :      # 79
            (red,green,blue,unknow)=(169,169,169,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(194,194,194,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>85 and green<=128 and blue>128 and blue<=170 :      # 82
            (red,green,blue,unknow)=(124,124,124,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>85 and green<=128 and blue>128 and blue<=170 :      # 83
            (red,green,blue,unknow)=(137,137,137,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(129,129,129,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>128 and red<=170 and green>85 and green<=128 and blue>212 :      # 86
            (red,green,blue,unknow)=(134,134,134,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>85 and red<=128 and green>128 and green<=170 and blue>128 and blue<=170 :      # 87
            (red,green,blue,unknow)=(136,136,136,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>170 and green<=212 and blue>128 and blue<=170 :      # 88
            (red,green,blue,unknow)=(161,161,161,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>212 and blue>128 and blue<=170 :      # 89
            (red,green,blue,unknow)=(186,186,186,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>128 and green<=170 and blue>170 and blue<=212 :      # 90
            (red,green,blue,unknow)=(141,141,141,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>128 and green<=170 and blue>212 :      # 91
            (red,green,blue,unknow)=(146,146,146,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(199,199,199,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>212 and blue>128 and blue<=170 :      # 94
            (red,green,blue,unknow)=(211,211,211,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue>170 and blue<=212 :      # 95
            (red,green,blue,unknow)=(166,166,166,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>128 and green<=170 and blue>170 and blue<=212 :      # 96
            (red,green,blue,unknow)=(179,179,179,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue>212 :      # 97
            (red,green,blue,unknow)=(171,171,171,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>170 and green<=212 and blue>170 and blue<=212 :      # 98
            (red,green,blue,unknow)=(178,178,178,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            
        elif red>128 and red<=170 and green>212 and blue>170 and blue<=212 :      # 99
            (red,green,blue,unknow)=(203,203,203,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>170 and green<=212 and blue>212 :      # 100
            (red,green,blue,unknow)=(183,183,183,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(220,220,220,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>170 and green<=212 and blue>212 :      # 103
            (red,green,blue,unknow)=(208,208,208,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>212 and blue>170 and blue<=212 :      # 104
            (red,green,blue,unknow)=(228,228,228,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(184,184,184,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>212 and blue<=42 :      # 112
            (red,green,blue,unknow)=(196,196,196,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>212 and green>85 and green<=128 and blue<=42 :      # 113
            (red,green,blue,unknow)=(135,135,135,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
    
        elif red>212 and green>128 and green<=170 and blue<=42 :      # 114
            (red,green,blue,unknow)=(160,160,160,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(155,155,155,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(165,165,165,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(120,120,120,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(182,182,182,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue>170 and blue<=212 :      # 131
            (red,green,blue,unknow)=(177,177,177,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>42 and red<=85 and green>212 and blue>128 and blue<=170 :      # 132
            (red,green,blue,unknow)=(173,173,173,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>212  and blue>85 and blue<=128 :      # 133
            (red,green,blue,unknow)=(181,181,181,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>212  and blue>128 and blue<=170 :      # 134
            (red,green,blue,unknow)=(198,198,198,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>212  and blue>170 and blue<=212 :      # 135
            (red,green,blue,unknow)=(216,216,216,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>170 and green<=212 and blue<=42 :      # 136
            (red,green,blue,unknow)=(172,172,172,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>212 and blue>128 and blue<=170 :      # 137
            (red,green,blue,unknow)=(201,201,201,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>170 and green<=212 and blue>128 and blue<=170 :      # 138
            (red,green,blue,unknow)=(174,174,174,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(132,132,132,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>170 and green<=212 and blue>85 and blue<=128 :      # 141
            (red,green,blue,unknow)=(156,156,156,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(122,122,122,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>85 and red<=128 and green>85 and green<=128 and blue<=42 :      # 144
            (red,green,blue,unknow)=(110,110,110,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>128 and red<=170 and green>85 and green<=128 and blue>85 and blue<=128 :      # 145
           (red,green,blue,unknow)=(97,97,97,255)
           i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue<=42 :      # 146
            (red,green,blue,unknow)=(147,147,147,255)
            i.putpixel((x,y,),(red,green,blue,unknow))

        elif red>170 and red<=212 and green>128 and green<=170 and blue>128 and blue<=170 :      # 147
            (red,green,blue,unknow)=(162,162,162,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(204,204,204,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
            ...
            (red,green,blue,unknow)=(164,164,164,255)
            i.putpixel((x,y,),(red,green,blue,unknow))
...
# Affichage du temps d execution
    print("Temps d execution monochromatique : %s secondes " % (time.time() - start_time))
